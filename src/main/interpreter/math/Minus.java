...
public class Minus
{
    public static Variable minus(Variable left, Variable right)
    {
        ...
        {
            return minusNumberNumber(left, right);
        }
        else
        {
    ...
    private static Variable minusNumberNumber(Variable left, Variable right)
    {
